  ...
  (function($, window) {
    ...
    chardinJs = (function() {
      ...
      chardinJs.prototype.start = function() {
        ...
        _ref = this.$el.find('*[data-intro]:not(:hidden)');
      ...
      chardinJs.prototype.stop = function() {
        return this.$el.find(".chardinjs-overlay").fadeOut((function(_this) {
          return function() {
            _this.$el.find('.chardinjs-helper-layer').remove();
            _this.$el.find('.chardinjs-show-element').removeClass('chardinjs-show-element');
            _this.$el.find('.chardinjs-relative-position').removeClass('chardinjs-relative-position');
            _this.$el.find(".chardinjs-overlay").remove();
            return true;
          };
        })(this));
      };
    ...
    ({
      _overlay_visible: function() {
        return this.$el.find('.chardinjs-overlay').length !== 0;
      },
      _add_overlay_layer: function() {
        ...
        $(overlay_layer).bind('click touchstart', (function(_this) {
          return function(event) {
            return _this.stop();
          };
        })(this));
        return this.$el.find(".chardinjs-overlay").fadeIn();
      },
      _get_position: function(element) {
        return element.getAttribute('data-position') || 'bottom';
      },
      _place_tooltip: function(element) {
      ...
      _position_helper_layer: function(element) {
        var element_position, error, helper_layer;
        try {
